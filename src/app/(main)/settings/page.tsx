...
type SettingsTab = 'general' | 'notifications' | 'security' | 'identity';
          ...
          {activeTab === 'identity' && (
            <div className="space-y-6">
              ...
              <div className="border border-border/60 rounded-3xl bg-card/20 backdrop-blur p-6 space-y-4 shadow-sm relative overflow-hidden">
                ...
                <div className="flex items-center gap-2.5 p-4 rounded-2xl bg-patr-orange/5 border border-patr-orange/20 text-xs text-muted-foreground leading-relaxed">
